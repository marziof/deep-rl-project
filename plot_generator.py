...
if args.env not in ["Pendulum-v1", "CartPole-v1", "LunarLander-v3", "InvertedPendulum-v5"]:
    raise ValueError("Unsupported environment. Please choose 'Pendulum-v1', 'CartPole-v1', 'LunarLander-v3', or 'InvertedPendulum-v5'.")
env_name = args.env
...
if env_name=="Pendulum-v1":
    ...
    FILE_NAME = "LunarLander_SAC/sac_LunarLander-v3_logs.csv"
    FILE_PATH = os.path.join(LOAD_DIR, FILE_NAME)
    results_df1 = pd.read_csv(FILE_PATH)
    ...
    FILE_NAME3 = "LunarLander_TD3/td3_LunarLander-v3_logs.csv"
    FILE_PATH3 = os.path.join(LOAD_DIR, FILE_NAME3)
    results_df3 = pd.read_csv(FILE_PATH3)
    ...
    SAVE_NAME = "InvertedPendulum_comparison.png"
    FILE_NAME = "InvertedPendulum_SAC/sac_InvertedPendulum-v5_logs.csv"
    FILE_PATH = os.path.join(LOAD_DIR, FILE_NAME)
    results_df1 = pd.read_csv(FILE_PATH)

    FILE_NAME2 = "InvertedPendulum_PPO/ppo_InvertedPendulum-v5_logs.csv"
    FILE_PATH2 = os.path.join(LOAD_DIR, FILE_NAME2)
    results_df2 = pd.read_csv(FILE_PATH2)

    FILE_NAME3 = "InvertedPendulum_TD3/td3_InvertedPendulum-v5_logs.csv"
    FILE_PATH3 = os.path.join(LOAD_DIR, FILE_NAME3)
    results_df3 = pd.read_csv(FILE_PATH3)
...
plot_env_curves(results_df, env_name=env_name, save_path=os.path.join(SAVE_DIR, SAVE_NAME), bin_size=10)